            ...
            <div className='footer-maxarea'>
                ...
                <div className='footer--lists'>
                    <div className='footer--language'>
                        <ul>
                            <a href=""><li>Idioma e legendas</li></a>
                    ...
                    <div className='footer--description'>
                        <ul>
                            <a href=""><li>Áudiodescrição</li></a>
                            <a href=""><li>Relação com investidores</li></a>
                            <a href=""><li>Avisos legais</li></a>
                        </ul>
                    </div>
                    <div className='footer--central'>
                        <ul>
                            ...
                            <a href=""><li>Preferências de cookies</li></a>
                        </ul>
                    </div>
                    <div className='footer--card'>
                        <ul>
                            ...
                            <a href=""><li>Informações corporativas</li></a>
                        </ul>
                    </div>
                </div>
